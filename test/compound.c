...
int main(int argc, char** argv)
{
  ...
  gasAnimation* animation1 = gasNumberAnimationNewFromTo(GAS_NUMBER_ANIMATION_TARGET_X, gasEasingLinear, 0.0f, 400.0f, 1.0f);
  gasAnimation* animation2 = gasNumberAnimationNewFromTo(GAS_NUMBER_ANIMATION_TARGET_Y, gasEasingQuadOut, 240.0f, 0.0f, 1.0f);
  gasAnimation* animation3 = gasNumberAnimationNewFromTo(GAS_NUMBER_ANIMATION_TARGET_Y, gasEasingQuadIn, 0.0f, 240.0f, 1.0f);
  gasAnimation* animation4 = gasNumberAnimationNewFromTo(GAS_NUMBER_ANIMATION_TARGET_X, gasEasingLinear, 400.0f, 800.0f, 1.0f);
  ...
  gasAnimation* topRight[] = {
    gasNumberAnimationNewDelta(GAS_NUMBER_ANIMATION_TARGET_X, gasEasingQuadIn, -100.0f, 1.0f),
    gasNumberAnimationNewDelta(GAS_NUMBER_ANIMATION_TARGET_Y, gasEasingQuadOut, -100.0f, 1.0f)
  };
  gasAnimation* topLeft[] = {
    gasNumberAnimationNewDelta(GAS_NUMBER_ANIMATION_TARGET_X, gasEasingQuadOut, -100.0f, 1.0f),
    gasNumberAnimationNewDelta(GAS_NUMBER_ANIMATION_TARGET_Y, gasEasingQuadIn, 100.0f, 1.0f)
  };
